...
class Ai_model_registry {
 public:
  ...
  Ai_error ResolveForTest(std::string_view model_name,
 ...
 private:
  Ai_error ResolveProfiles(std::string_view model_name,
                           Ai_capability capability,
...
class Ai_credential_resolver {
 public:
  /** Resolve the opaque instance credential for the supported Provider. */
